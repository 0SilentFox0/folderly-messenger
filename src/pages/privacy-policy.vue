    ...
    <ContainerNew>
      ...
      <div class="tabs">
        <div v-for="(tab, index) in tabs" :key="index" class="tab">
          <router-link :to="tab.link" class="tab-title">{{
            tab.title
          }}</router-link>
        </div>
      </div>
      ...
      <div class="article-base">
        ...
        <div class="update">Last updated: October 25, 2021</div>
        ...
        <p>
          ...
          "Us" or "Our" in this Agreement) refers to Folderly Inc, 8 The Green
          Suite #10781 Dover, DE 19901.
        </p>
        ...
        <p>
          <strong>Facebook Fan Page</strong> is a public profile named Folderly
          specifically created by the Company on the Facebook social network,
          accessible from
          <a href="https://www.facebook.com/Folderly/"
            >https://www.facebook.com/Folderly/</a
          >
        </p>
        <p>
        ...
        <p>
          <strong>Website</strong> refers to Folderly, accessible from
          <a href="https://folderly.com/">http://folderly.com/</a>
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            <a
              ...
              >https://www.adobe.com/products/flashplayer/end-of-life.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</a
            >
          </li>
          <li>
        ...
        <p>
          If you are a citizen or resident of the EEA, the following provision
          applies to your personal data. In certain cases, we need to transfer
          your data outside the EEA in order to provide our services to you.
          This is due to the fact that Belkins works in multiple jurisdictions
          with our offices and contractors located around the world. We strive
          to implement appropriate technical and organizational measures to
          ...
          alteration, unauthorized disclosure, or access to that data. We also
          ensure that only the necessary minimum amount of data is transferred
          and the data is promptly erased when we no longer need it. By agreeing
          with this Privacy Policy you acknowledge that you are informed about
          possible risks related to the transfer of personal data outside the
          EEA and you provide your consent to such transfer.
        </p>
        ...
        <h2><strong>Behavioral Remarketing</strong></h2>
        <p>
        ...
        <p>
          These third-party vendors collect information about Your activity on
          Our Service to enable Us to:
        </p>
        <ul>
          <li>
        ...
        <ul>
          <li>
            ...
            <a href="https://www.networkadvertising.org/choices/"
              >https://www.networkadvertising.org/choices/</a
            >
          </li>
          <li>
          ...
          <li>
            ...
            <a href="https://optout.aboutads.info/?c=2&amp;lang=EN"
              >https://optout.aboutads.info/?c=2&amp;lang=EN</a
            >
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          instructions:
          <a href="https://help.twitter.com/articles/20170405"
            >https://help.twitter.com/articles/20170405</a
          >
        </p>
        <p>
        ...
        <p>
          ...
          <a href="https://youradchoices.ca/">https://youradchoices.ca/</a> or
        ...
        <p>
          ...
          <a
            ...
            >http://info.evidon.com/pub_info/573?v=1&amp;nt=1&amp;nw=false</a
          >
          ...
          <a
            ...
            >https://help.adroll.com/hc/en-us/articles/216599538-Opting-Out-of-Personalized-Advertising</a
          >
        </p>
        <p>
          ...
          Inc.:
          <a href="https://www.nextroll.com/privacy#service-13"
            >https://www.nextroll.com/privacy#service-13</a
          >
        </p>
        <p>
          For more information on the privacy practices of AdRoll, please visit
          the NextRoll, Inc. Privacy Policy web page:
          <a href="https://www.nextroll.com/privacy"
        ...
        <p>
          ...
          <a href="https://www.xandr.com/">https://www.xandr.com/</a>
        </p>
        <p>
        ...
        <h2><strong>Your Rights under the GDPR</strong></h2>
        <p>
        ...
        <h2><strong>Exercising of Your GDPR Data Protection Rights</strong></h2>
        <p>
        ...
        <h2><strong>Data Controller for the Facebook Fan Page</strong></h2>
        <p>
        ...
        <h2><strong>Facebook Insights</strong></h2>
        <p>
        ...
        <h2><strong>Categories of Personal Information Collected</strong></h2>
        <p>
        ...
        <h2><strong>Sources of Personal Information</strong></h2>
        <p>
        ...
        <h2><strong>Sale of Personal Information</strong></h2>
        <p>
          ...
          Iinformation, but not necessarily a monetary benefit.
        </p>
        <p>
        ...
        <h2><strong>Share of Personal Information</strong></h2>
        <p>
        ...
        <h2><strong>Your Rights under the CCPA</strong></h2>
        <p>
        ...
        <h2><strong>Exercising Your CCPA Data Protection Rights</strong></h2>
        <p>
          In order to exercise any of Your rights under the CCPA, and if You are
          a California resident, You can contact Us:
        </p>
        <p>By email: support@folderly.com</p>
        <p>
          By visiting this page on our website:
          <a href="http://folderly.com/">http://folderly.com/</a>
        </p>
        <p>By mail: 8 The Green Suite #10781 Dover, DE 19901</p>
        <p>
        ...
        <h2><strong>Do Not Sell My Personal Information</strong></h2>
        <p>
        ...
        <p>
          If you have any questions about our Privacy Policy or you wish to
          exercise your rights under the GDPR please contact us:
        </p>
        <p>
          By email:
          <a href="mailto:support@folderly.com">support@folderly.com</a> or
          <a href="mailto:office@folderly.com" target="_blank" rel="noopener"
            >office@folderly.com</a
          >
        </p>
        <p>
          By visiting this page on our website:
        ...
        <div class="home-button">
          <router-link to="/">Go Gome</router-link>
        </div>
      </div>
    </ContainerNew>
  </section>
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      items: [
        'Application means the software program provided by the Company downloaded by You on any electronic device, named Folderly.',
        'Application means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.',
        'Affiliate means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.',
        'Account means a unique account created for You to access our Service or parts of our Service.',
        'Country refers to: Delaware, United States',
        'Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Folderly Inc, 8 The Green Suite #10781 Dover, DE 19901.',
        ...
        'Website refers to Folderly, accessible from http://folderly.com/',
...
.article-base {
  ...
  a {
    ...
    &:visited {
      ...
      border-bottom: 1px solid $color-gray-warm-dark;
    }
    &:hover {
      opacity: 0.8;
    }
  ...
  blockquote {
    ...
    &::before {
      ...
      content: url('/assets/img/blockquote-icon.svg');
    }
  }
